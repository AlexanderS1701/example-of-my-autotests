...
class HomePageHelper:
    ...
    def check_header(self):
        with allure.step('Проверить наличие заголовка на странице'):
    ...
    def check_placeholders(self):
        with allure.step('Проверить наличие плейсхолдера Куда/Откуда'):
            placeholders_data = [
                {'element_name': hp.ARR_INPUT, 'placeholder': 'Куда'},
                {'element_name': hp.DEP_INPUT, 'placeholder': 'Откуда'},
            ]
            for p in placeholders_data:
                self._check_placeholder(p['element_name'], p['placeholder'])

    def _check_placeholder(self, element_name, expected_placeholder):
    ...
    def check_city(self, key, city_name):
        with allure.step('Проверить отображения введенного города'):
            data = {
    ...
    def check_swap_city_button(self):
        with allure.step('Проверить отображение кнопки SWAP_CITY'):
    ...
    def check_text_content_in_passengers_button(self, pax_class='Эконом', amount='1'):
        with allure.step('Проверить отображение текста в форме к-ва и типа пассажиров'):
    ...
    def check_hotel_checkbox(self):
        with allure.step('Проверить наличие чекбокса подбора отеля'):
    ...
    def check_search_button(self):
        with allure.step('Проверить отображение кнопки поиска'):
    ...
    def check_search_history_is_missing(self):
        with allure.step('Проверить отсутствие отображения истории поиска'):
    ...
    def check_search_history(self):
        with allure.step('Проверить отображение истории поиска'):
    ...
    def _select_city(self, field_selector, city, index):
    ...
    def select_departure(self, city, index=0):
        ...
        with allure.step('Установить город отправления'):
            self._select_city(hp.DEP_INPUT, city, index)

    def select_arrival(self, city, index=0):
        """На вход принимает код или название города"""
        with allure.step('Установить город прибытия'):
            self._select_city(hp.ARR_INPUT, city, index)

    def click_swap_button(self):
        with allure.step('Нажать на кнопку SWAP_CITY'):
    ...
    def click_remove_complex_route_button(self, remove):
        with allure.step('Нажать на кнопку удаления сегмента сложного маршрута'):
    ...
    def check_complex_route_button(self):
        with allure.step('Проверить состояние кнопки добавления сегмента сложного маршрута'):
    ...
    def check_remove_complex_route_button(self):
        with allure.step('Проверить состояние кнопки удаления сегмента сложного маршрута'):
            remove_complex_route_button = self.driver.find_elements(
                By.CSS_SELECTOR, hp.REMOVE_COMPLEX_ROUTE_BUTTON
            )
    ...
    def click_passengers_data_input(self):
        with allure.step('Нажать на кнопку выбора класса и к-ва пассажиров'):
    ...
    def check_passengers_data_input(self):
        with allure.step('Проверить отображение кнопки выбора класса и к-ва пассажиров'):
    ...
    def click_default_pax_btn(self):
        with allure.step('Нажать на дефолтный тип пассажира и проверить отображение элементов'):
    ...
    def click_young_pax_btn(self):
        with allure.step('Нажать на молодежный тип пассажиров и проверить отображение элементов'):
    ...
    def choose_pax_class(self, pax_class):
        ...
        with allure.step('Выбрать класс пассажира'):
            business_btn = self.driver.find_element(By.CSS_SELECTOR, hp.BUSINESS_BTN)
            econom_btn = self.driver.find_element(By.CSS_SELECTOR, hp.ECONOM_BTN)
            if pax_class == 'econom':
                econom_btn.click()
    ...
    def change_passengers_amount(self, pax_type, change, amount=1):
        ...
        with allure.step('Изменить количество пассажиров'):
    ...
    def check_limits_of_amount_passengers(self, pax_types: list[str], disabled: str):
        ...
        with allure.step('Проверить ограничения на количество пассажиров'):
    ...
    def check_adults_not_less_than_infant(self):
        with allure.step('Проверка правила: количество младенцев не может быть больше, чем взрослых'):
    ...
    def check_pax_summ_is_less_than_9(self):
        with allure.step('Проверка правила: количество пассажиров не может быть больше, чем 9'):
            counter = self.driver.find_elements(By.CSS_SELECTOR, hp.COUNTER)
    ...
    def check_date_input(self):
        with allure.step('Проверить заполненность формы ввода даты перелета'):
    ...
    def click_date_pick_button(self, index=0):
        ...
        with allure.step('Нажать на кнопку открытия календаря и проверить отображение элементов в нем'):
            date_pick_button = self.driver.find_elements(By.CSS_SELECTOR, hp.DATE_PICK_BUTTON)
    ...
    def check_upper_bound_dates(self):
        with allure.step('Проверить верхние ограничения на выбор даты (не позднее 360 дня)'):
            last_month = self.driver.find_element(By.CSS_SELECTOR, hp.LAST_MONTH_IN_LIST)
            last_month.click()
    ...
    def check_lower_bound_dates(self):
        with allure.step('Проверить нижние ограничения на выбор даты (не ранее текущего дня)'):
            first_month = self.driver.find_element(By.CSS_SELECTOR, hp.FIRST_MONTH_IN_LIST)
            first_month.click()
    ...
    def set_date_value(self, key):
        with allure.step('Установить дату перелета'):
            data = {
    ...
    def set_i_dont_need_back(self):
        with allure.step('Нажать на кнопку "Мне не нужен билет обратно"'):
